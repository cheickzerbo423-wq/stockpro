...
import {
  ...
  utilisateursService, gammesService, devisService,
} from "../services";
...
export const useGammes = () =>
  useApi(() => gammesService.getAll());

export const useDevis = (filters) =>
  useApi(() => devisService.getAll(filters), [JSON.stringify(filters)]);
